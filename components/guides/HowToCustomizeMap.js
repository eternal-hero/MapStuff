...
const HowToCustomizeMap = () => {
  const { t } = useTranslation();
  return (
    <>
      <div>
        <div
          id="HowToCustomizeMap"
            ...
            <div className="relative py-16 overflow-hidden bg-white">
              <div className="relative px-4 sm:px-6 lg:px-8">
                ...
                <div className="mx-auto mt-6 prose text-gray-500 prose-indigo prose-md">
                  <p>{t("help_guides_support.how_to_customize_map.step_1")}</p>
                  <ol className="list-inside">
                    <li>
                      {t("help_guides_support.how_to_customize_map.step_2")}
                    </li>
                    <li>
                      {t("help_guides_support.how_to_customize_map.step_3")}
                    </li>
                    <li>
                      {t("help_guides_support.how_to_customize_map.step_4")}
                    </li>
                    <li>
                      {t("help_guides_support.how_to_customize_map.step_5")}
                    </li>
                    <li>
                      {t("help_guides_support.how_to_customize_map.step_6")}
                    </li>
                  </ol>
                  <p> {t("help_guides_support.how_to_customize_map.step_7")}</p>
                </div>
              </div>
            </div>
          </div>
...
export default HowToCustomizeMap;
