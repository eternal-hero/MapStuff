...
const WhyIsMapboxKeyNeeded = ({ children }) => {
  const { t } = useTranslation();
  return (
    <>
      <div>
        <div
          id="WhyIsMapboxKeyNeeded"
            ...
            <div className="relative py-16 overflow-hidden bg-white">
              <div className="relative px-4 sm:px-6 lg:px-8">
                ...
                <div className="mx-auto mt-6 prose text-gray-500 prose-indigo prose-md">
                  <p>
                    {t("help_guides_support.why_do_you_need_mapbox_key.step_1")}{" "}
                    <Link
                      href="https://account.mapbox.com/auth/signup/"
                      title="Sign up on Mapbox"
                    >
                      {t(
                        "help_guides_support.why_do_you_need_mapbox_key.step_2"
                      )}
                    </Link>
                  </p>
                </div>
...
export default WhyIsMapboxKeyNeeded;
